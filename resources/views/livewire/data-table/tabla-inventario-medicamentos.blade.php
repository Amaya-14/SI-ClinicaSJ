<div>
    @php
        $heads = ['#', 'Medicamento', 'Tipo', 'Cantidad', 'Lote', 'Vencimiento', ['label' => 'Opciones', 'no-export' => true, 'width' => 5]];
        ...
        $btnDetails = '<button class="btn btn-xs btn-secondary text-white mx-1 shadow" title="Ver/Editar registro" 
                        data-bs-toggle="modal" data-bs-target="#updateInventarioMedicamento">
                        <i class="fas fa-lg fa-fw fa-eye"></i>
                      </button>';
        
        $config = [
            'data' => [[1, 'Medicamento', 'Ingreso', '100', 'Lote 1', '03/03/2022','<nobr>' . $btnDelete . $btnDetails . '</nobr>']],
            'order' => [[1, 'asc']],
    ...
    <x-adminlte-datatable id="tablaInventarioMedicamentos" :heads="$heads" beautify hoverable striped with-buttons>
