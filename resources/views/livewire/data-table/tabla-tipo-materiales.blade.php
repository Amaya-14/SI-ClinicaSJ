<div>
    @php
        ...
        $btnDetails = '<button class="btn btn-xs btn-secondary text-white mx-1 shadow" title="Ver/Editar registro"
                        data-bs-toggle="modal" data-bs-target="#updateTipoMaterial">
                        <i class="fas fa-lg fa-fw fa-eye"></i>
                        </button>';
        
        $config = [
            'data' => [[1, 'Limpieza', 'Descipción', '<nobr>' . $btnDelete . $btnDetails . '</nobr>']],
            'order' => [[1, 'asc']],
            'columns' => [null, null, null, ['orderable' => false]],
        ];
    @endphp

    <x-adminlte-datatable id="tablaTipoMaterial" :heads="$heads" beautify hoverable striped with-buttons>
