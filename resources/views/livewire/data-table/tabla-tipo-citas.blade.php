<div>
    @php
        ...
        $btnDetails = '<button class="btn btn-xs btn-secondary text-white mx-1 shadow" title="Detalles/Editar"
                        data-toggle="modal" data-target="#updateEstadoCita">
                        <i class="fas fa-lg fa-fw fa-eye"></i>
                        </button>';
        
        $config = [
            'data' => [[1, 'Libre', 'Descipción', '<nobr>' . $btnDelete . $btnDetails . '</nobr>']],
            'order' => [[1, 'asc']],
            'columns' => [null, null, null, ['orderable' => false]],
        ];
    @endphp

    <x-adminlte-datatable id="tablaEstadoCitas" :heads="$heads" beautify hoverable striped with-buttons>
