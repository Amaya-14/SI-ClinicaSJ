<div>
    @php
        $heads = ['#', 'Persona', 'Teléfono', 'Tipo', ['label' => 'Opciones', 'no-export' => true, 'width' => 5]];
        ...
        $btnDetails = '<button class="btn btn-xs btn-secondary text-white mx-1 shadow" title="Ver/Editar registro"
                        data-bs-toggle="modal" data-bs-target="#updateTelefono">
                        <i class="fas fa-lg fa-fw fa-eye"></i>
                        </button>';
        
        $config = [
            'data' => [[1, 'Nombre', '+504 1111-1111', 'Móvil', '<nobr>' . $btnDelete . $btnDetails . '</nobr>']],
            'order' => [[1, 'asc']],
            'columns' => [null, null, null, ['orderable' => false]],
        ];
    @endphp

    <x-adminlte-datatable id="tablaTelefonosPersonas" :heads="$heads" beautify hoverable striped with-buttons>
