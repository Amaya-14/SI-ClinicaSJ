<div>
    <form action="" method="post">
        {!! csrf_field() !!}
        @method('put')
        <x-adminlte-modal id="updateInventarioMaterial" title="Inventario de material" theme="purple"
            icon="fas fa-eye" v-centered static-backdrop scrollable>
            <section>
                <div class="input-group mb-3">
                    <label class="input-group-text" for="u-material">Material<span class="text-danger">*</span></label>
                ...
                <div class="input-group mb-3">
                    ...
                    <select class="form-select" name="u-estado-material" id="u-estado-material"
                        aria-label="Estado del material" aria-describedby="input-u-estado-material" required>
                        <option selected disabled value="">Seleccione...</option>
                ...
                <div class="input-group mb-3">
                    <label class="input-group-text" for="u-cantidad-material">Cantidad<span
                            class="text-danger">*</span></label>
                    <input type="number" class="form-control" name="u-cantidad-material" id="u-cantidad-material"
                        aria-label="Cantidad material" aria-describedby="input-u-cantidad-material" placeholder=""
                        required>
                </div>
                <!-- cantidad material -->
                <div class="input-group mb-3">
