<div>
    <form action="" method="post">
        {!! csrf_field() !!}
        @method('put')
        <x-adminlte-modal id="updatePuestoTrabajo" title="Puesto de trabajo" theme="purple" icon="fas fa-eye" v-centered
            static-backdrop scrollable>
            <section>
                <div class="input-group mb-3">
                    <label class="input-group-text" for="u-nombre-puesto-trabajo">Nombre<span
                            class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="u-nombre-puesto-trabajo" id="u-nombre-puesto-trabajo"
                        aria-label="Nombre del puesto trabajo" aria-describedby="input-u-nombre-puesto-trabajo"
