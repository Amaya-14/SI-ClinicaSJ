<div>
    <form action="" method="post">
        {!! csrf_field() !!}
        <x-adminlte-modal id="createInventarioMedicamento" title="Nuevo inventario de médicamento" theme="teal"
            icon="fas fa-plus" v-centered static-backdrop scrollable>
            <section>
                <div class="input-group mb-3">
                    <label class="input-group-text" for="c-medicamento">Medicamento<span
                ...
                <!-- tipo de registro -->
                <div class="input-group mb-3">
                    <label class="input-group-text" for="c-estado-medicamento">Estado<span
                            class="text-danger">*</span></label>
                    <select class="form-select" name="c-estado-medicamento" id="c-estado-medicamento"
                        aria-label="Estado del medicamento" aria-describedby="input-c-estado-medicamento" required>
                        <option selected disabled value="">Seleccione...</option>
                ...
                <!-- estado medicamento -->
                <div class="input-group mb-3">
                    <label class="input-group-text" for="c-cantidad-medicamento">Cantidad<span
                            class="text-danger">*</span></label>
                    <input type="number" class="form-control" name="c-cantidad-medicamento"
                        id="c-cantidad-medicamento" aria-label="Cantidad medicamento"
                        aria-describedby="input-c-cantidad-medicamento" placeholder="" required>
                </div>
                <!-- cantidad medicamento -->
                <div class="input-group mb-3">
                    <label class="input-group-text" for="c-lote-medicamento">Lote</label>
                    <input type="text" class="form-control" name="c-lote-medicamento" id="c-lote-medicamento"
                        aria-label="Lote medicamento" aria-describedby="input-c-lote-medicamento"
                        placeholder="Ingrese el lote" required>
                </div>
                <!-- lote medicamento -->
                <div class="input-group mb-3">
                    <label class="input-group-text" for="c-fecha-vencimiento">Fecha vencimiento<span
                            class="text-danger">*</span></label>
