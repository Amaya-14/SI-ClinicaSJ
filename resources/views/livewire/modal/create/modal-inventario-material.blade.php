<div>
    <form action="" method="post">
        {!! csrf_field() !!}
        <x-adminlte-modal id="createInventarioMaterial" title="Nuevo registro (Material)" theme="teal" icon="fas fa-plus" v-centered static-backdrop scrollable>
            <section>
                ...
                <div class="input-group mb-3">
                    <label class="input-group-text" for="c-estado-material">Estado<span class="text-danger">*</span></label>
                    <select class="form-select" name="c-estado-material" id="c-estado-material" aria-label="Estado del material" aria-describedby="input-c-estado-material" required>
                        <option selected disabled value="">Seleccione...</option>
                ...
                <div class="input-group mb-3">
                    <label class="input-group-text" for="c-cantidad-material">Cantidad<span class="text-danger">*</span></label>
                    <input type="number" class="form-control" name="c-cantidad-material" id="c-cantidad-material" aria-label="Cantidad material" aria-describedby="input-c-cantidad-material" placeholder="" required>
                </div><!-- cantidad material -->

                <div class="input-group mb-3">
                    <label class="input-group-text" for="c-lote-material">Lote</label>
                    <input type="text" class="form-control" name="c-lote-material" id="c-lote-material" aria-label="Lote material" aria-describedby="input-c-lote-material" placeholder="Ingrese el lote (Opcional)">
                </div><!-- lote material -->
