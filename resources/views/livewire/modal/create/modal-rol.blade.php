<div>
    <form action="" method="post">
        {!! csrf_field() !!}
        <x-adminlte-modal id="createRol" title="Nuevo Rol" theme="teal" icon="fas fa-plus" v-centered static-backdrop
            scrollable>
            <section>
                <div class="input-group mb-3">
                    <label class="input-group-text" for="c-nombre-rol">Nombre<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="c-nombre-rol" id="c-nombre-rol"
                        aria-label="Nombre del rol" aria-describedby="input-c-nombre-rol"
                ...
                <div class="input-group">
                    ...
                    <textarea class="form-control" name="c-descripcion-rol" id="c-descripcion-rol"
                        aria-label="Descripción del rol" aria-describedby="input-c-descripcion-rol"
