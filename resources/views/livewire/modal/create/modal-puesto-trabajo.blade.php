        ...
        <x-adminlte-modal id="createPuestoTrabajo" title="Nuevo puesto de trabajo" theme="teal" icon="fas fa-plus"
            ...
            <section>
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="c-nombre-puesto-trabajo" id="c-nombre-puesto-trabajo"
                        aria-label="Nombre del puesto trabajo" aria-describedby="input-c-nombre-puesto-trabajo"
